...
> Source of truth: `knowledge/blueprints/gb_event_kampfsport.json` (v1.0,
> status `active`).
>
...
|  3 | standards   | `vstaettvo/overview.md`                                          |
|  4 | sdls        | `veranstaltungsschutz/base.md`                                   |
|  5 | sdls        | `veranstaltungsschutz/subtypes/kampfsport.md`                    |
|  6 | products    | `gefaehrdungsbeurteilung/purpose.md`                             |
|  7 | products    | `gefaehrdungsbeurteilung/content_blocks.md`                      |
...
| 16 | examples    | `gb_gefaehrdungen/veranstaltungsschutz_kampfsport.md`            |
