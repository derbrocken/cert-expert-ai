...
### Audits & Fristen (nächste 14 Tage)
...
```bash
# Briefing neu erzeugen (nach Updates in hq/):
python3 hq/scripts/build_dashboard.py
```

Später: Sprachnotiz → Telegram → gleiche To-do-Dateien → Briefing neu bauen.
