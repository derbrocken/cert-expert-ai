...
// Wenn Kurzhh vorhanden, hier einen anderen Text anzeigen
if (typeof txts[bereich+'_k']=="undefined") document.write('Bearbeiten Sie die vorgeschlagenen Auswahlbögen, ergänzen Sie weitere entsprechend Ihrer betrieblichen Situation.');
else document.write('Bearbeiten Sie die vorgeschlagenen Auswahlbögen, ergänzen Sie weitere entsprechend Ihrer betrieblichen Situation.<br> Falls Sie eine vorhandene Kurzhandlungshilfe für '+bereichtxt+' \ einbinden oder zunächst eine anfertigen möchten, beginnen Sie bitte mit dem grauen Button unten rechts.');
