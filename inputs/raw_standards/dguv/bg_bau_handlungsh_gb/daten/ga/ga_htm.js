   ...
   if (medium=="monitor") drucklink="ga.htm"+location.search.replace("&monitor","")+"&print";
...
//   if (bereich=="alles") medium="print";
   ...
   if (l1[0]!="erglist" && l1[0]!="maengel" && l1[0]!="kontroll" && l1[0]!="risikobewertung" && medium=="monitor")  tab_kopf_fest_ga("table_faktor");  
