...
risiko_txt["Gefahrstoffe"]='Vergiftungen; Erkrankungen (auch Krebs) der Haut, der Lunge,  des Nervensystem, andere Organschäden ; Allergien; Verbrennungen I.-III. Grades; Fruchtschädigungen';
risiko_txt["Hautgefährdung"]='Abnutzungsekzem; Kontaktallergie; Eindringen von Gefahrstoffen';
risiko_txt["Hitze, Klima"]='Konzentrationsmängel; Leistungsabfall; Zunahme von Arbeitsfehlern - unfällen; Herzkreislaufbelastung; Hitzekrämpfe; Hitzekollaps; Hitzschlag;  Verbrennungen I.-III. Grades';
...
risiko_txt["Körperliche Überlastung"]='Überlastung einzelner Muskelgruppen und Gelenke; Rückenschmerzen;  Gelenks- und Sehnenentzündungen, bei langer Einwirkung Bandscheibenschäden';
...
risiko_txt["Psychische Fehlbeanspruchungen"]='Stress; psychosomatische Erkrankungen; erhöhter Alkohol- Nikotin- und Medikamentenkonsum; Resignation;  nachlassende Konzentration - Fehler- und Unfallhäufigkeit steigen';
...
risiko_txt["Sturz in das Wasser"]='Ertrinken; Unterkühlen';
...
risiko_link["Arbeiten in Zwangshaltung"]='ga_bau/f_ko/ko16023.htm';
risiko_link["Biologische Arbeitsstoffe"]='gv/biostoffv/2.htm';
...
risiko_link["Ertrinken"]='bau/infom/b9.htm';
...
risiko_link["Infektionsgefahr"]='ga_bau/f_i/i12007.htm';
risiko_link["Körperliche Überlastung"]='ga_bau/f_ku/ku8002.htm';
...
risiko_link["Psychische Fehlbeanspruchungen"]='ga_bau/f_all/all01034.htm';
...
function ga_ausgeben(zeile, medium)
{
   ...
   if (zeile=="erglist" || zeile=="maengel" || zeile=="kontroll" || zeile=="risikobewertung") {
       ...
       if (zeile=="erglist") document.write('<h3>Ergebnisse der<br>Kurzhandlungshilfe</h3></p>');
   ...
   if (zeile!="erglist" && zeile!="maengel" && zeile!="kontroll" && zeile!="risikobewertung"&& zeile!="kurzhh"&& zeile!="print"&& zeile!="clipbrd") {
       ...
       // NEU: jetzt die restlichen Faktoren ausgeben, die nicht in der Struktur sind.
   	   for (var i in parent.ga_daten) { if (typeof schon_ausgegebene_faktoren[i]=="undefined") faktor_ausgeben(i, zeile, medium, '');}
   	   //
       ...
       if (aenderungsliste) document.getElementById("aenderungen").innerHTML='<p style="background-color:red;color:white;padding:2px">Hinweise auf Änderungen sind in folgenden Faktoren vorhanden:<br />'+aenderungsliste+
...
{  
   var erg='';
   var bereich_farbe='004B93', bereich_farbe_hell='c8c8c8';
   var f_preview=0;
   ...
   if (zeile.substring(0,8)!='preview_') {
      ...
      //document.write('zeile='+zeile+'<br>');
      //document.write('ga='+ga+'<br>');
   }
   ...
   if (g.length<2 && typ!=""&& typ!="kurzhh") return;
   ...
   mass_txt='Maßnahmen auswählen<br /></b><small>(nur die Maßnahmen auswählen, die für Ihre Arbeit relevant sind)</small><br /><br /><br /><br /><br /><br /><a href="'+xpath+'help/kurzhh.htm"><i style="font-weight:bold;color:white" title="Hinweise zur Durchführung der Gefährdungsbeurteilung"> i</i></a>';
   ...
   if (dateiname=="f_blanko") {
   	   ...
   	   fragen[nr]='Ziel/Frage:<br /><input type="text" size="50" style="width:600px" name="i'+(anz_input+2)+'" value="'+repl_anf(g[2+anz_input+2])+'" />';
   ...
   if (typeof pfad_pos=="object") {
       ...
       try{
           ...
           else erg+=' > <a href="'+xpath+'ga_kurzhh/ga_'+bereich+'.htm">'+faktortitel/*titel[nr]*/+ ' <span class="vd" title="vollständigen Auswahlbogen aufrufen">&#x270E;</span></a></b></p>';
   ...
   if (typ=='kurzhh') {
// gelöscht weil: Tabellenüberschrift jetzt erst unter kopf ausgeben
//if (faktortitel!="-") erg+='          <p><b style="font-size:14px">'+faktortitel+'</b></p><div class="clear" style="clear:both"></div>';
   } 
 else {
...
<col width="23">\
 ...
 tabellenanfang_merk=kopf;
   if (flag_kein_kopf==0) kopf+='\
<tr id="fest2" bgcolor="#'+bereich_farbe_hell+'">\
<td rowspan="2" style="font-size:13px;color:black"><b>'+mass_txt+'</td>\
<td colspan="2" style="font-size:13px;color:black"><b>festgelegte Maßnahmen</b></td>\
<td colspan="2" style="font-size:13px;color:black"><b>Maßnahmen&nbsp;kontrollieren</b>&nbsp;</td>\
<td rowspan="2" style="font-size:13px;color:black">\
<img src="'+path+(flag_kurzhh?'ga_kurzhh/':'')+'grafik/bemerkungen.gif" width="18" height="94" alt="Bemerkungen" /></td>\
</tr>\
<tr id="fest2" bgcolor="#'+bereich_farbe_hell+'">\
<td style="font-size:13px;color:black">Umgesetzt<br /><br />\
<small>&nbsp;</small><br />\
<small>(evtl. unter <img border="0" width="10" height="10" src="'+path+'grafik/stern.gif" /> dokumen-<br />\
tieren)</small></td>\
<td style="font-size:13px;color:black">Handlungsbedarf<br />zur Umsetzung<br />\
<small>&nbsp;</small><br />\
...
<b>Wer<br />\
Bis wann</b></td>\
<td style="font-size:13px;color:black"><br />\
&nbsp;<br />\
<small>&nbsp;<br /><br /></small><br />\
<br />\
ok</td>\
</tr>\r\n';
   if (typ!="kurzhh")erg+='<h4>'+repl(fragen[nr])+'</h4>';

   warnflag_alteversion=0;
   if (parent.f_alte_version_geladen==1 && hinweis_neu[nr]) {
       erg+='<a name="fakt_'+dateiname+'"></a>';
       //erg+='<p style="background-color:red;color:white;padding:2px">Hinweis auf Änderungen: '+hinweis_neu[nr]+'</p>'; warnflag_alteversion=1; 
       aenderung='<a href="#fakt_'+dateiname+'" style="color:black">'+titel[nr]+'</a><br />';
       }

   
   // Neu: Bei den Kurzhh die Überschrift unter dem Kopf anzeigen.
   if (typ=="kurzhh"){
       if (flag_kein_kopf==0) erg+=kopf+'</table>';
       if (faktortitel!="-") erg+='          <p><b style="font-size:14px">'+faktortitel+'</b></p><div class="clear" style="clear:both"></div>';
       erg+=tabellenanfang_merk;   
       if (typ=="kurzhh") flag_kein_kopf=1;   
   }
   else erg+=kopf;
   //
   ...
   if (medium=="monitor") {
    ...
    for(var i1=0;i1<m.length;i1++) {
      var i=m[i1].substring(0,2);         // Nummer der Maßnahme z.B. 01
      if (kurzhh_nur_zeilen && kurzhh_nur_zeilen.indexOf(","+i+',')==-1) continue; // Bei Kurzhh, wenn nur bestimmte Zeilen angezeigt werden sollen (s. struktur_xx_k.js), die Zeilen überspringen, die nicht angezeigt werden sollen.
      i=parseInt(i);
      var ii=i*inp_z;
      var ic=i*cb_z;
      ...
      massn=ersetze_bausteinlinks(massn);
...
<div style="margin-left: 20px;background-color:#e0f0ff;">' +g[2+nr6+ii].replace(/\r/g,"<br />")+ '</div>\
</td>\
</tr>\r\n');
          }
      }
...
function ersetze_bausteinlinks(massn)
{
      if (massn.indexOf("#")!=-1) {
      	    var bausteinlinks=massn.split("#")[1].split(",");
      	    massn=massn.split("#")[0];
      	    
      	    massn+='<p align="right">Bausteine: ';
      	    for(var j=0; j<bausteinlinks.length; j++) {
      	    	   if (j>0) massn+=', ';
      	    	   var bausteinlink=bausteinlinks[j].toLowerCase().replace(" ", "_");
      	    	   massn+='<a href="'+xpath+'/bausteine/'+bausteinlink+'/'+bausteinlink+'.htm">'+bausteinlinks[j]+'</a>';
      	    }
            massn+='</p>';
      }
   return massn;
