...
| Personalfreigabe | Freigabe je Verwendung | `qualifications/05` · `06` (SDL-Fokus) | 77200-1 (+ 77200-2) | **vorhanden** (CEKS V1) |
| Einsatzfreigabe | Freigabe je Schicht/Einsatz | `qualifications/07_einsatz_release_v1.md` | 77200-1 (+ 77200-2) | **vorhanden** (CEKS V1) |
