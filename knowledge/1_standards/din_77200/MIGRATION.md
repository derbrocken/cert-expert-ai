...
| Governance | `knowledge/1_standards/din_77200/` | README, MIGRATION, ARCHITECTURE, AGENT_RULES, ROADMAP |

`din_77200/` ist **keine** Inhaltsablage.
...
**Status:** Entfernung empfohlen und sicher (kein alleiniger Inhaltshalter).

---

## Falsche Pfadvariante (korrigieren)
...
- Vorlagen in `din_77200/<dokumenttyp>/`
