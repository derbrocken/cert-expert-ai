...
Unter `knowledge/guides/risk_patterns/` werden typische **Risiko- und Gefährdungsmuster** geführt (z. B. aggressive Gruppen, Gedränge). Die Dateien hier beschreiben **geeignete Maßnahmenlogiken und Umsetzungsdimensionen**, die zu diesen Mustern passen können.
